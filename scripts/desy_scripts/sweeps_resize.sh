...
# python ../../fun/__main__.py --no-compile --max-epochs=10 --devices cuda:0 --num-workers=0 --model-save-freq=9999 --forced-run-name="CNO-64x64-$NUM-sweep"    --model=cno         --dataset=ellipses-sweep --batch-size=32 --resize-input-size=64  --test-only --weights=/home/kabrisam/Code/FNO-UNet/runs/CNO-64x64-$NUM/weights/best-all.pt  
# python ../../fun/__main__.py --no-compile --max-epochs=10 --devices cuda:0 --num-workers=0 --model-save-freq=9999 --forced-run-name="CNO-128x128-$NUM-sweep"  --model=cno         --dataset=ellipses-sweep --batch-size=32 --resize-input-size=128 --test-only --weights=/home/kabrisam/Code/FNO-UNet/runs/CNO-128x128-$NUM/weights/best-all.pt  
# python ../../fun/__main__.py --no-compile --max-epochs=10 --devices cuda:0 --num-workers=0 --model-save-freq=9999 --forced-run-name="CNO-256x256-$NUM-sweep"  --model=cno         --dataset=ellipses-sweep --batch-size=32 --resize-input-size=256 --test-only --weights=/home/kabrisam/Code/FNO-UNet/runs/CNO-256x256-$NUM/weights/best-all.pt 
